...
public class UserTest extends TicketTest {
  ...
  {
    assertTrue(dao.addUser(testUser));
  ...
  {
    String expectedEmailID="sean_bean@gameofthron.es";
    String actualEmailID=dao.getUser(expectedEmailID).getEmail();
  ...
  public void testLogout() {
    ...
    assertTrue("Should have deleted user from sessions collection - check your logout method",
        dao.deleteUser(email));
    assertNull("All sessions for user should have been deleted after logout", dao.getUserSession(email));
