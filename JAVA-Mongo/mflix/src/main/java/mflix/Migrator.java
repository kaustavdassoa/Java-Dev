...
public class Migrator {
  ...
  public static void main(String[] args) {
   ...
   // String mongoUri = "mongodb+srv://m220student:<MY_SUPER_SECURE_PASSWORD>@cluster0-aojz2.azure.mongodb.net/mflix";
    ...
    String mongoUri = "mongodb+srv://m001-student:m001-mongodb-basics@learningcluster.glnnl.mongodb.net/admin";
    ...
    //System.out.println(MessageFormat.format("Number of documents found : {0} number of document found post filtering {0}",movies.countDocuments(),movies.countDocuments(dateStringFilter)));
    ...
    //Bson ratingStringFilter = exists("imdb.rating");
